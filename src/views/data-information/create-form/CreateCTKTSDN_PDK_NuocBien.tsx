...
const Form = ({ data, setPostSuccess, closeDialogs }: any) => {
  const [CTKTSDN_PDK_NuocBienData, setCTKTSDN_PDK_NuocBienData] = useState<State>({
    id: data?.id || 0,
  ...
  const handleChange = (prop: keyof State) => (value: any) => {
    setCTKTSDN_PDK_NuocBienData({ ...CTKTSDN_PDK_NuocBienData, [prop]: value })
  }
  ...
  const handleSubmit = async (e: any) => {
    ...
    const handleApiCall = async () => {
      setSaving(true)
      try {
        const res = await saveData('CTKTSDN_PDK_NuocBien/luu', CTKTSDN_PDK_NuocBienData)
        if (res) {
          // Reset form fields
          setCTKTSDN_PDK_NuocBienData({
            id: 0,
            tenCongTrinh: '',
            tenTCCN: '',
            namVanHanh: '',
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.tenCongTrinh || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.tenTCCN || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.namVanHanh || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.xa || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.huyen || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.x || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.y || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.tenVungbien || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.cheDoLayNuoc || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.diemLayNuoc || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.congSuatTho || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.congSuatTinh || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.soToMay || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.luuLuongKTMax || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.soMayBom || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.diemXaNuocLamMat || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.luuLuongXaMax || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.congSuatThietKe || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.phuongThucKT || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.mucDichKT || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.cheDoKT || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.soGP || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.ngayQuyetDinh || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.thoiGianHieuLuc || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.idCongTrinh || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.thoiGianBatDauKetNoi || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PDK_NuocBienData.ghiChu || ''}
...
const CreateCTKTSDN_PDK_NuocBien = ({ data, setPostSuccess, isEdit }: any) => {
...
export default CreateCTKTSDN_PDK_NuocBien

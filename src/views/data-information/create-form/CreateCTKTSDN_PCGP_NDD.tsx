...
const Form = ({ data, setPostSuccess, closeDialogs }: any) => {
  const [CTKTSDN_PCGP_NDDData, setCTKTSDN_PCGP_NDDData] = useState<State>({
    id: data?.id || 0,
  ...
  const handleChange = (prop: keyof State) => (value: any) => {
    setCTKTSDN_PCGP_NDDData({ ...CTKTSDN_PCGP_NDDData, [prop]: value })
  }
  ...
  const handleSubmit = async (e: any) => {
    ...
    const handleApiCall = async () => {
      setSaving(true)
      try {
        const res = await saveData('CTKTSDN_PCGP_NDD/luu', CTKTSDN_PCGP_NDDData)
        if (res) {
          // Reset form fields
          setCTKTSDN_PCGP_NDDData({
            id: 0,
            tenCongTrinh: '',
            tenTCCN: '',
            namVanHanh: '',
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.tenCongTrinh || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.tenTCCN || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.namVanHanh || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.huyen || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.luuVuc || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.tangChuaNuoc || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.soGieng || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.chieuSauCacGieng || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.toaDoCacGieng || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.mucDichKT || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.soToMay || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.tongLuuLuongKT || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.cheDoKT || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.phuongThucKT || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.thoiGianVanHanh || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.tinhHinhCapGP || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.soGP || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.ngayQuyetDinh || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.thoiGianHieuLuc || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.thoiGianKetThuc || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.idCongTrinh || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.thoiGianBatDauKetNoi || ''}
        ...
        <Grid item xs={12} md={6} sm={12}>
          <TextField
            ...
            fullWidth
            placeholder=''
            value={CTKTSDN_PCGP_NDDData.ghiChu || ''}
...
const CreateCTKTSDN_PCGP_NDD = ({ data, setPostSuccess, isEdit }: any) => {
...
export default CreateCTKTSDN_PCGP_NDD

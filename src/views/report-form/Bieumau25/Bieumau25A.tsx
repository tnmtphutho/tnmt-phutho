    ...
    <Paper sx={{ p: 8 }}>
      ...
      <Grid container>
        <Grid md={11}>
          <Typography variant='h5'>
            Biểu mẫu số 25. Tổng hợp các đặc trưng về nồng độ các chất ô nhiễm theo từng thông số quy định trong giấy
            phép nước mặt
          </Typography>
        </Grid>
        <Grid md={1}>
      ...
      <Grid className='_text_center'>
        ...
        <Typography className='font-weight-bold ' variant='h6'>
          Tổng hợp các đặc trưng về nồng độ các chất ô nhiễm theo từng thông số quy định trong giấy phép nước mặt
        </Typography>
        <Typography className='font-weight-bold ' variant='h6'>
...
const Bieumau25A = () => {
  const formTitle = 'BIỂU MẪU THÔNG TƯ 31/2018/TT-BTNMT/ BIỂU MẪU SỐ 25A'
      ...
      {(openDialogs: (content: React.ReactNode, title: React.ReactNode) => void) => (
        <>
          <Link className='formReport_box' onClick={() => openDialogs(<FormContruction />, formTitle)}>
            <Grid item xs={8}>
              <Typography className='text-danger text-weight-bold'>Biểu mẫu 25A</Typography>
              <Typography className='text-success text-weight-bold _font12'>
                Thông số ô nhiễm quy định trong giấy phép(nước mặt)
              </Typography>
            </Grid>
            <Grid item xs={4}>

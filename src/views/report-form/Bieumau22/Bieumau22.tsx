    ...
    <Paper sx={{ p: 8 }}>
      ...
      <Grid container>
        <Grid md={11}>
          ...
          Biểu mẫu số 22. Tổng hợp tình hình khai thác, sử dụng nước mặt đối với loại hình khai thác, sử dụng nước khác hồ chứa
          </Typography>
        </Grid>
        <Grid md={1}>
          <IconButton>
            ...
            <TableHead className='tableHead'>
              <TableRow>
                ...
                <TableCell size='small' align='center' rowSpan={2}>
                  Lưu lượng khai thác <br/> được cấp phép<br />
                  (m3/ngày đêm hoặc m3/s tùy loại hình)
                </TableCell>
                <TableCell size='small' align='center' rowSpan={2}>
                  Số ngày <br />

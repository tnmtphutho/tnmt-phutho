...
import Mua12HourData from './rain-data'
import Mua12HourChart from './rain-chart'
...
const FormAmountRain: React.FC<FormAmountRainProps> = (props) => {
    ...
    return (
        <Grid>
            ...
            <TabPanel value="1"><Mua12HourData stationdata={data} /></TabPanel>
            <TabPanel value="2"><Mua12HourChart stationdata={data} /></TabPanel>
...
const ViewAmountRain12HourData: React.FC<AmountRainProps> = ({ data }) => {
...
export default ViewAmountRain12HourData

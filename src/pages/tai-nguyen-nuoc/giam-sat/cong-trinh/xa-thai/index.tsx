...
import DischargeConstruction from "src/views/construction/dischargewater"
...
const DischargeWater = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <DischargeConstruction /> : <Error401 />;}

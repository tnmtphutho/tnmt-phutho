...
import DischargewaterMeasuresing from "src/views/measuresing/discharge-water"
...
const ManageGround = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <DischargewaterMeasuresing /> : <Error401 />;
}

...
import GroundQuantity from "src/views/water-reserve/ground-water/quantity"

const GroundWaterReserve = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <GroundQuantity /> : <Error401 />;
}

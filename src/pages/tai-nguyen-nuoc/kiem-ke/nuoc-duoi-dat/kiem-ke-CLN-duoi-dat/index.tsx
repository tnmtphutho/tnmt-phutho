...
import KiemKeCLNDuoiDat from "src/views/water-reserve/ground-water/kiem-ke-CLN-duoi-dat"

const KiemKeCLNDuoiDatPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <KiemKeCLNDuoiDat /> : <Error401 />;
}

export default KiemKeCLNDuoiDatPages
...
import RainWater from "src/views/water-reserve/rain-water"

const RainWaterReserve = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <RainWater /> : <Error401 />;
}

export default RainWaterReserve
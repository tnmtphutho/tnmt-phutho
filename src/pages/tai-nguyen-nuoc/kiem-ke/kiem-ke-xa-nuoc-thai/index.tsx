...
import KiemKeXaNuocThai from "src/views/water-reserve/xa-nuoc-thai"

const KiemKeXaNuocThaiPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <KiemKeXaNuocThai /> : <Error401 />;
}

export default KiemKeXaNuocThaiPages
...
import ExploitSurfaceWater from "src/views/water-reserve/surface-water/exploit"
...
const ExploitSFW = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <ExploitSurfaceWater /> : <Error401 />;
}

export default ExploitSFW
...
import TotalSFWater from "src/views/water-reserve/surface-water/total"

const TotalWaterReserve = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <TotalSFWater /> : <Error401 />;
}

export default TotalWaterReserve
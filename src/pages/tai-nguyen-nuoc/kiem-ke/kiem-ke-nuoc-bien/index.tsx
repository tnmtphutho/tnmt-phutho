...
import KiemKeNuocBien from "src/views/water-reserve/nuoc-bien"

const KiemKeNuocBienPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <KiemKeNuocBien /> : <Error401 />;
}

export default KiemKeNuocBienPages
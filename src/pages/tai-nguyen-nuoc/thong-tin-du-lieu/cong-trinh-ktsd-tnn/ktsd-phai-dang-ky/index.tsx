...
const KTSDPhaiDangKyPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <KTSDPhaiDangKy /> : <Error401 />;
}

export default KTSDPhaiDangKyPages
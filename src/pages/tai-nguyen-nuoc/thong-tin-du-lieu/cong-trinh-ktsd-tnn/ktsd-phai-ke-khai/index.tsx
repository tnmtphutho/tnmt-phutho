...
import KTNDDPhaiKeKhai from "src/views/data-information/cong-trinh-KTSD-TNN/KTSD-phai-ke-khai"

const KTNDDPhaiKeKhaiPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <KTNDDPhaiKeKhai /> : <Error401 />;
}

export default KTNDDPhaiKeKhaiPages
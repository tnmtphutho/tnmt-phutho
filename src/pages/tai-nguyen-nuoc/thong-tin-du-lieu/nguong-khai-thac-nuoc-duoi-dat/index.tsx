...
import NguongKTNuocDuoiDat from "src/views/data-information/nguong-khai-thac-nuoc-duoi-dat"

const NguongKTNuocDuoiDatPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <NguongKTNuocDuoiDat /> : <Error401 />;
}

export default NguongKTNuocDuoiDatPages
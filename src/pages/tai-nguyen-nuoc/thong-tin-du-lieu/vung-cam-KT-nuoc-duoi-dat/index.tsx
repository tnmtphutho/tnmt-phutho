...
const VungCamKTNuocDuoiDatPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <VungCamKTNuocDuoiDat /> : <Error401 />;
}

export default VungCamKTNuocDuoiDatPages
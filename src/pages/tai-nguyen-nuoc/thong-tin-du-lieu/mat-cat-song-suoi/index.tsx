...
import MatCatSongSuoi from "src/views/data-information/mat-cat-song-suoi"

const MatCatSongSuoiPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <MatCatSongSuoi /> : <Error401 />;
}

export default MatCatSongSuoiPages
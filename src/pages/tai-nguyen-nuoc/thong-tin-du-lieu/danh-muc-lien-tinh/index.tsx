...
import DanhMucNguonNuocLienTinh from "src/views/data-information/danh-muc-nguon-nuoc-lien-tinh"

const DanhMucNguonNuocLienTinhPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <DanhMucNguonNuocLienTinh /> : <Error401 />;
}

export default DanhMucNguonNuocLienTinhPages

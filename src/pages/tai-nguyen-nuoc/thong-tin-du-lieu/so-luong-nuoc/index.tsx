...
import QuantitySFWater from "src/views/data-information/quantitywater"
...
const QuanityPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <QuantitySFWater /> : <Error401 />;
}

export default QuanityPages

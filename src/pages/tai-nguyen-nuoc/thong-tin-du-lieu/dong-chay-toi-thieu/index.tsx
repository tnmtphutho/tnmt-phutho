...
import DongChayToiThieu from "src/views/data-information/dong-chay-toi-thieu"
...
const QuaityPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <DongChayToiThieu /> : <Error401 />;
}

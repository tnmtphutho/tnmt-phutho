...
const ExploitSufacePages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <ExploitSFWater /> : <Error401 />;
}

export default ExploitSufacePages

...
import NguonNuoc from "src/views/data-information/nguon-nuoc"

const NguonNuocPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <NguonNuoc /> : <Error401 />;
}

export default NguonNuocPages
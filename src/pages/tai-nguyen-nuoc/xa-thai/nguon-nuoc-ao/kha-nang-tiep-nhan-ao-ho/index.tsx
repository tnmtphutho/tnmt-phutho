...
import KhaNangTiepNhanNuocThaiAo from "src/views/receive-wastewater/AoHo/kha-nang-tiep-nhan-ao-ho"

const KhaNangTiepNhanAoHoPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <KhaNangTiepNhanNuocThaiAo /> : <Error401 />;
}

export default KhaNangTiepNhanAoHoPages

...
import DuLieuNguonThaiCLN from "src/views/receive-wastewater/lake/du-lieu-nguon-thai"

const DuLieuNguonThaiCLNPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <DuLieuNguonThaiCLN /> : <Error401 />;
}

export default DuLieuNguonThaiCLNPages
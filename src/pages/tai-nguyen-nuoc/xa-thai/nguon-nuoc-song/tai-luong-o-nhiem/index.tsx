...
const TaiLuongONhiemCLN = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <TaiLuongONhiem /> : <Error401 />;
}

export default TaiLuongONhiemCLN

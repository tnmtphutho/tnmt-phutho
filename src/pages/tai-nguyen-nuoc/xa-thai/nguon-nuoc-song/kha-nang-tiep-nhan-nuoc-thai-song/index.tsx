...
const KhaNangTiepNhanNuocThaiSongPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <KhaNangTiepNhanNuocThaiSong /> : <Error401 />;
}

export default KhaNangTiepNhanNuocThaiSongPages

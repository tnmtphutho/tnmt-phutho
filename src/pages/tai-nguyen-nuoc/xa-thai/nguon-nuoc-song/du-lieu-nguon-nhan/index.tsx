...
import WasteWaterDetails from "src/views/receive-wastewater/lake/wastewater-source"
...
const CLN = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <WasteWaterDetails /> : <Error401 />;
}

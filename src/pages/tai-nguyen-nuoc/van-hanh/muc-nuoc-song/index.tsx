...
import MucNuocSong from 'src/views/van-hanh-ho-chua/muc-nuoc-song';


const MucNuocSongPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <MucNuocSong /> : <Error401 />;
}

export default MucNuocSongPages

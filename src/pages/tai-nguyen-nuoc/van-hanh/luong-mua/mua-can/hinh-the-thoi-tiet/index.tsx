...
const HinhTheThoiTietGayMuaPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <HinhTheThoiTietGayMua /> : <Error401 />;
}

export default HinhTheThoiTietGayMuaPages
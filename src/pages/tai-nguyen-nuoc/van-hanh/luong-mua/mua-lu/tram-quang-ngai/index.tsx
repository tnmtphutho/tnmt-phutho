...
import TramQuangNgai from "src/views/van-hanh-ho-chua/tram-quang-ngai"


const TramQuangNgaiPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <TramQuangNgai /> : <Error401 />;
}

export default TramQuangNgaiPages

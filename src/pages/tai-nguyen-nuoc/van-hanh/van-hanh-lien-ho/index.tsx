...
import VanHanhLienHo from "src/views/van-hanh-ho-chua/van-hanh-lien-ho"

const VanHanhLienHoPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <VanHanhLienHo /> : <Error401 />;
}

export default VanHanhLienHoPages
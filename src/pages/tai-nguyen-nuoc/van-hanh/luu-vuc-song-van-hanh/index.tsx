...
import VanHanhHoChuaLuuVucSong from "src/views/van-hanh-ho-chua/luu-vuc-song-van-hanh"

const VanHanhHoChuaLuuVucSongPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <VanHanhHoChuaLuuVucSong /> : <Error401 />;
}

export default VanHanhHoChuaLuuVucSongPages
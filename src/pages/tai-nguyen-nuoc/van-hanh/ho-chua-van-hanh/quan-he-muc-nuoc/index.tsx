...
import QuanHeMucNuoc from "src/views/van-hanh-ho-chua/thong-tin-ho-chua"

const QuanHeMucNuocPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <QuanHeMucNuoc /> : <Error401 />;
}

export default QuanHeMucNuocPages
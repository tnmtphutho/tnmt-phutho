...
const HoChuaVanHanhPages = () => {
    ...
    return loading ? <Typography align='center'><CircularProgress /></Typography> : accessView ? <HoChuaVanHanh /> : <Error401 />;
}

export default HoChuaVanHanhPages